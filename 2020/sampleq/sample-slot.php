...
<?php
  ...
  <table align="center">
    ...
    <tr>
      <td><?php echo "<img src=./slot_images/syoki.png>"?></td>
	  <td><?php echo "<img src=./slot_images/huwa.png >"?></td>
    </tr>
	...
	<br></br>
        <?php
		  ...
		  && $numberArray[0]==$numberArray[8]){
            ...
            echo "<img src= ./slot_images/wakuwaku.png>";
          }

        ?>
		<link rel="stylesheet"href="style.css">
		 <div class="slot_Document">
		<iframe src="http://learn.secret.jp/2020/doc/slot.pdf" width="550" height="320" frameborder="0" style="border:0" allowfullscreen>
		</iframe>
		</div>
    </tr>
	</tr>
