class Input{
    ...
    static init(){
        ...
        window.onkeydown = function(ev){
            ...
            if (code){ this.codeLogger[code] = this.codeLogger[code] == 0 ? 1 : 2; }
        }.bind(this);
        window.onkeyup = function(ev){
            const code = this.parseCode(ev.code);
            if (code){ this.codeLogger[code] = 0; }
        }.bind(this);
    }
    ...
    static setButton(tdr, code){
        ...
        tdr.onmouseup = tdr.ontouchend = function(ev){ this.codeLogger[code] = 0; }.bind(this);
    }
